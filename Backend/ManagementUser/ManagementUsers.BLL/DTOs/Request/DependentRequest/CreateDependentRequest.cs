...
{
    public class CreateDependentRequest : DependentRequest
    {
        public List<CreateDependentDataRequest?> DependentsData { get; set; } = new List<CreateDependentDataRequest?>();
    }

    public class CreateDependentDataRequest
    {
